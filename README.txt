...
step1: download and install scapy module 
      ...
      cmd: pip install --pre scapy[complete]
 
or download and install scapy module 
       
    link: githubhttps://github.com/secdev/scapy
 
To install : Move to that directory using terminal, 

 then cmd: python setup.py install 

step2: Move to our tool location

serp3: If python 2.7
      cmd :pyhton arp_spoofer2.py   
       If pyhton 3.8 or 3.9 
      cmd: pyhton3 arp_spoofer3.py
